...
$('#addDoc').click(function(){
	...
	if (forAddress != ''){
		...
		if (forAddCheck == -1){
			...
			var autofill = "<label class='checkbox-inline'><input type='checkbox' name='addCheck' class='addCheck' value="+addCount+">Click, if you would like this document also forwarded to: "+forAddress+"</label>"
